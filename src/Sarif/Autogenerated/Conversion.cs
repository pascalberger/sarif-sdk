...
namespace Microsoft.CodeAnalysis.Sarif
{
    ...
    public partial class Conversion : PropertyBagHolder, ISarifNode
    {
        ...
        /// </param>
        public Conversion(ToolComponent driver, Invocation invocation, IEnumerable<ArtifactLocation> analysisToolLogFiles, IDictionary<string, SerializedPropertyInfo> properties)
        {
        ...
        private void Init(ToolComponent driver, Invocation invocation, IEnumerable<ArtifactLocation> analysisToolLogFiles, IDictionary<string, SerializedPropertyInfo> properties)
        {
            if (driver != null)
            {
