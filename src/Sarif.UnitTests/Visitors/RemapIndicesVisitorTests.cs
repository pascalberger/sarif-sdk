...
namespace Microsoft.CodeAnalysis.Sarif.Visitors
{
    public class RemapIndicesVisitorTests
    {
        ...
        public void RemapIndicesVisitor_RemapsNestedFilesProperly()
        {
            ...
            //    CurrentFiles property is equivalent to mergedRun.Artifacts. The visitor
            ...
            Artifact artifact = mergedRun.Artifacts[mergedRun.Results[1].Locations[0].PhysicalLocation.ArtifactLocation.Index];

            // Most nested
            artifact.ParentIndex.Should().Be(2);
            mergedRun.Artifacts[artifact.ParentIndex].ParentIndex.Should().Be(1);
            mergedRun.Artifacts[mergedRun.Artifacts[artifact.ParentIndex].ParentIndex].ParentIndex.Should().Be(-1);
        }
    }
}
