    ...
    internal sealed class InvocationEqualityComparer : IEqualityComparer<Invocation>
    {
        ...
        public bool Equals(Invocation left, Invocation right)
        {
            ...
            if (!object.ReferenceEquals(left.NotificationConfigurationOverrides, right.NotificationConfigurationOverrides))
            {
                ...
                for (int index_2 = 0; index_2 < left.NotificationConfigurationOverrides.Count; ++index_2)
                {
                    if (!ReportingConfigurationOverride.ValueComparer.Equals(left.NotificationConfigurationOverrides[index_2], right.NotificationConfigurationOverrides[index_2]))
                    {
                        return false;
                    }
                }
            ...
            if (!object.ReferenceEquals(left.RuleConfigurationOverrides, right.RuleConfigurationOverrides))
            {
                ...
                for (int index_3 = 0; index_3 < left.RuleConfigurationOverrides.Count; ++index_3)
                {
                    if (!ReportingConfigurationOverride.ValueComparer.Equals(left.RuleConfigurationOverrides[index_3], right.RuleConfigurationOverrides[index_3]))
                    {
                        return false;
                    }
                }
        ...
        public int GetHashCode(Invocation obj)
        {
            ...
            unchecked
            {
                ...
                {
                    foreach (var value_6 in obj.NotificationConfigurationOverrides)
                    {
                        result = result * 31;
                        if (value_6 != null)
                        {
                ...
                {
                    foreach (var value_7 in obj.RuleConfigurationOverrides)
                    {
                        result = result * 31;
                        if (value_7 != null)
                        {
