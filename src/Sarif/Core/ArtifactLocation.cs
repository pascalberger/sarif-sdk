...
namespace Microsoft.CodeAnalysis.Sarif
{
    public partial class ArtifactLocation
    {
        ...
        /// </summary>
        /// <param name="artifactionLocation">The fileLocatio instance from which an absolute URI should be reconstructed, if possible.</param>
        ...
        public bool TryReconstructAbsoluteUri(IDictionary<string, ArtifactLocation> originalUriBaseIds, out Uri resolvedUri)
        {
            ...
            {
                if (originalUriBaseIds.TryGetValue(this.UriBaseId, out ArtifactLocation artifactionLocation))
                {
                    resolvedUri = new Uri(artifactionLocation.Uri, resolvedUri.ToString());
                }
            }
