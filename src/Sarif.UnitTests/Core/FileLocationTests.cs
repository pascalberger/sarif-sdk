...
namespace Microsoft.CodeAnalysis.Sarif.UnitTests.Core
{
    public class FileLocationTests
    {
        ...
        public void FileLocation_CreateFromFilesDictionaryKey()
        {
            ...
            {
                var artifactionLocation = ArtifactLocation.CreateFromFilesDictionaryKey(key: testCase.Item1, parentKey: testCase.Item2);
                if (!artifactionLocation.ValueEquals(testCase.Item3))
                {
