...
namespace Microsoft.CodeAnalysis.Sarif
{
    public class SarifLoggerTests : JsonTests
    {
        ...
        public void SarifLogger_RedactedCommandLine()
        {
            ...
            //
            // "C:\Program Artifacts (x86\\Microsoft Visual Studio 14.0\Common7\IDE\QTAgent32_40.exe\" 
            ...
            //
            // pathToExe   = C:\Program Artifacts (x86)\Microsoft Visual Studio 14.0\Common7\IDE\CommonExtensions\Microsoft\TestWindow\Extensions
        ...
        public void SarifLogger_WritesRunProperties()
        {
            ...
            using (var textWriter = new StringWriter(sb))
            {
                ...
                run.MarkdownMessageMimeType = markdownMessageMimeType;
            ...
            run.MarkdownMessageMimeType.Should().Be(markdownMessageMimeType);
        ...
        public void SarifLogger_WritesFileDataWithUnrecognizedEncoding()
        {
            ...
            var sarifLog = JsonConvert.DeserializeObject<SarifLog>(logText);
            Artifact artifact = sarifLog.Runs[0].Artifacts[0];
            artifact.MimeType.Should().Be(MimeType.CSharp);
            artifact.Contents.Binary.Should().Be(Convert.ToBase64String(fileBytes));
