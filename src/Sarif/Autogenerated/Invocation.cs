...
namespace Microsoft.CodeAnalysis.Sarif
{
    ...
    public partial class Invocation : PropertyBagHolder, ISarifNode
    {
        ...
        /// <summary>
        /// An array of reportingConfigurationOverride objects that describe runtime notification reporting behavior.
        /// </summary>
        [DataMember(Name = "notificationConfigurationOverrides", IsRequired = false, EmitDefaultValue = false)]
        public IList<ReportingConfigurationOverride> NotificationConfigurationOverrides { get; set; }

        /// <summary>
        /// An array of reportingConfigurationOverride objects that describe runtime rule reporting behavior.
        /// </summary>
        [DataMember(Name = "ruleConfigurationOverrides", IsRequired = false, EmitDefaultValue = false)]
        public IList<ReportingConfigurationOverride> RuleConfigurationOverrides { get; set; }
        ...
        private void Init(string commandLine, IEnumerable<string> arguments, IEnumerable<ArtifactLocation> responseFiles, DateTime startTimeUtc, DateTime endTimeUtc, int exitCode, IEnumerable<ReportingConfigurationOverride> notificationConfigurationOverrides, IEnumerable<ReportingConfigurationOverride> ruleConfigurationOverrides, IEnumerable<Notification> toolExecutionNotifications, IEnumerable<Notification> toolConfigurationNotifications, string exitCodeDescription, string exitSignalName, int exitSignalNumber, string processStartFailureMessage, bool toolExecutionSuccessful, string machine, string account, int processId, ArtifactLocation executableLocation, ArtifactLocation workingDirectory, IDictionary<string, string> environmentVariables, ArtifactLocation stdin, ArtifactLocation stdout, ArtifactLocation stderr, ArtifactLocation stdoutStderr, IDictionary<string, SerializedPropertyInfo> properties)
        {
            ...
            if (notificationConfigurationOverrides != null)
            {
                ...
                foreach (var value_2 in notificationConfigurationOverrides)
                {
                    if (value_2 == null)
                    {
                ...
                NotificationConfigurationOverrides = destination_2;
            }

            if (ruleConfigurationOverrides != null)
            {
                var destination_3 = new List<ReportingConfigurationOverride>();
                foreach (var value_3 in ruleConfigurationOverrides)
                {
                    if (value_3 == null)
                    {
                ...
                RuleConfigurationOverrides = destination_3;
            }
